...
export default function NavBar(props) {
  ...
  return (
    <>
      <nav
        className={`navbar brdr rounded navbar-expand-lg ${
          props.mode === "light" ? "border border-dark" : "border border-light"
        }`}
      >
        <div className="container-fluid">
          <a
            className={`navbar-brand active text-${
              props.mode === "light" ? "dark" : "light"
            }`}
            onClick={handleTextConverter}
          >
            Text Converter
          </a>
          <button
          ...
          >
            <span
              className={`navbar-toggler-icon text-${
