    ...
    <>
      <div>
        <div className="container ">
          ...
          >
            Try Now: Text Converter - Word and Character Counter & Case
            Converter:
          </h2>
          ...
          <div className="my-3">
            <textarea
              className={`form-control fnt-fmly my-2 bg-${
        ...
        >
          ...
          <p>
            ...
            <strong>words</strong>, {text.length} <strong>characters</strong>,{" "}
            {(text.match(/[^\w\s]/g) || []).length}{" "}
            <strong>special characters</strong>
          </p>
          <p>
            <b>Total Time to Read:</b>{" "}
            {0.008 *
              text.split(" ").filter((element) => {
                return element.length !== 0;
              }).length}{" "}
